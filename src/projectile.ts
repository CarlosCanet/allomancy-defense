...
export class Projectile extends GameObject {
    ...
    targetY: number;
    isOnTarget: boolean;
    constructor(x: number, y: number, w: number, h: number, speedX: number, speedY: number, node: HTMLDivElement, gameBoxNode: HTMLDivElement, targetX: number, targetY: number) {
